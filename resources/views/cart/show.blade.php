            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td class="col-sm-1 col-md-1" style="text-align: center">
                        <input type="email" class="form-control" id="exampleInputEmail1" value="{{$cart['totalQty']}}">
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-right"><h5><strong>${{$carts->totalPrice}}</strong></h5></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>   </td>
                    <td><h3>Total</h3></td>
                    <td class="text-right"><h3><strong>${{$carts->totalPrice}}</strong></h3></td>
                </tr>
                <tr>
                    <td>   </td>
                    <td>   </td>
